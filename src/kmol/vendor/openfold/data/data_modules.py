...
from kmol.vendor.openfold.data import (
    data_pipeline,
    feature_pipeline,
    mmcif_parsing,
    templates,
)
from kmol.vendor.openfold.utils.tensor_utils import tensor_tree_map, dict_multimap
        ...
        """
            Args:
                ...
                alignment_dir:
                    ...
                    (defined in kmol.vendor.openfold.features.alignment_runner).
                ...
                config:
                    A dataset config object. See kmol.vendor.openfold.config
