...
from kmol.vendor.openfold.model.evoformer import EvoformerStack, ExtraMSAStack
...
import kmol.vendor.openfold.np.residue_constants as residue_constants
...
from kmol.vendor.openfold.utils.loss import (
    compute_plddt,
)
