...
class SGDLinearModel(LinearModel):
    def __init__(self, **kwargs) -> None:
        ...
        """
        # avoid cycles
        from vendor.captum._utils.models.linear_model.train import sgd_train_linear_model
...
class SkLearnLinearModel(LinearModel):
    def __init__(self, sklearn_module: str, **kwargs) -> None:
        ...
        """
        # avoid cycles
        from vendor.captum._utils.models.linear_model.train import sklearn_train_linear_model
