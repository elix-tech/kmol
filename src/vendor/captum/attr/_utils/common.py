...
from vendor.captum._utils.common import _format_baseline, _format_input, _format_output
from vendor.captum._utils.common import _validate_input as _validate_input_basic
...
from vendor.captum.attr._utils.approximation_methods import SUPPORTED_METHODS

if TYPE_CHECKING:
    from vendor.captum.attr._utils.attribution import GradientAttribution
