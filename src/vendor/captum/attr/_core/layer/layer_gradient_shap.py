...
from vendor.captum._utils.gradient import _forward_layer_eval, compute_layer_gradients_and_eval
from vendor.captum._utils.typing import Literal, TargetType, TensorOrTupleOfTensorsGeneric
