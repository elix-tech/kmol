...
from vendor.captum._utils.common import _format_input, _format_output, _is_tuple
from vendor.captum._utils.gradient import (
    apply_gradient_requirements,
    undo_gradient_requirements,
)
from vendor.captum._utils.typing import TargetType, TensorOrTupleOfTensorsGeneric
