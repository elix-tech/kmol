...
from vendor.captum.attr._utils.batching import _batched_generator
from vendor.captum.insights.attr_vis.attribution_calculation import (
    AttributionCalculation,
    OutputScore,
)
from vendor.captum.insights.attr_vis.config import (
    ATTRIBUTION_METHOD_CONFIG,
    ATTRIBUTION_NAMES_TO_METHODS,
)
from vendor.captum.insights.attr_vis.features import BaseFeature
from vendor.captum.insights.attr_vis.server import namedtuple_to_dict
...
class AttributionVisualizer:
    ...
    def render(self, debug=True):
        ...
        from vendor.captum.insights.attr_vis.widget import CaptumInsights
    ...
    def _serve(self, blocking=False, debug=False, port=None, bind_all=False):
        from vendor.captum.insights.attr_vis.server import start_server
