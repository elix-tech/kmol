...
from vendor.captum._utils.common import _format_output
from vendor.captum._utils.gradient import _forward_layer_eval
from vendor.captum._utils.typing import ModuleOrModuleList
from vendor.captum.attr._utils.attribution import LayerAttribution
